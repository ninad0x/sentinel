...
export function Hero() {
  return (
    <section className="relative max-w-6xl mx-auto flex items-center justify-center">
        ...
        {/* Hero content */}
        <div className="relative z-10 flex items-center justify-center min-h-[calc(100vh-64px)] px-8">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <h1 className="text-6xl md:text-7xl font-bold text-gray-900 text-shadow tracking-tight leading-tight">
            ...
            <div className="flex items-center justify-center gap-4 pt-6">
              <Link
                href="/dashboard"
                className="px-8 py-4 bg-gray-900 text-white text-sm font-medium rounded-lg hover:bg-gray-800 transition"
              >
                Get Started
              </Link>
